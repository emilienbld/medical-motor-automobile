...
//   // VARIABLES SIMPLIFIÉES pour gérer le joystick
...
//   // MÉTHODE SIMPLIFIÉE - Envoi direct sans vitesse
...
//   // MÉTHODE SIMPLIFIÉE : Arrêt forcé
//   void _forceStop() {
//     _isMoving = false;
...
//   // MÉTHODE SIMPLIFIÉE : Gérer l'arrêt proprement
//   void _handleStop() {
//     if (_isMoving) {
...
//    // Timer d'arrêt automatique (sécurité)
...
//   // MÉTHODE SIMPLIFIÉE ET CORRIGÉE du joystick
//   void _onJoystickMove(double x, double y) {
//     print('Joystick: x=$x, y=$y');

//     // Seuil pour réduire la sensibilité
//     const seuil = 0.45;
//     double amplitude = sqrt(x * x + y * y);

//     // Zone morte pour éviter les démarrages accidentels
//     if (amplitude < seuil) {
//       _handleStop();
//       return;
//     }
...
//               ),
//               const Text(
//                 'Utilisez le joystick pour déplacer le robot (mode simple)',
//                 style: TextStyle(
//                   fontSize: 12,
//                   color: Colors.grey,
//                 ),
